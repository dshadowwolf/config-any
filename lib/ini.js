...
function Parser(file) {
  ...
  this.open = function(filen) {
    if( filen != undefined ) {
      this.filename = filen;;
      var f = fs.readFileSync( filen );
      this.data = f.toString().split('\n');
    } else if( this.filename != undefined ) {
      var fd = fs.readFileSync( this.filename );
      this.data = fd.toString().split('\n');
    } else {
